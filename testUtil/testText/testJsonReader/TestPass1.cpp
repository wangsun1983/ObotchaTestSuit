...
int testpass1() {
    ...
    //new json value
        ...
        if(value8_7->toValue() != 1) {
          TEST_FAIL("[JsonReader testPass case15]");
          return 0;
        }
        ...
        if(!value8_19->toValue()) {
          TEST_FAIL("[JsonReader testPass case27]");
          return 0;
        }
        ...
        if(value8_20->toValue()) {
          TEST_FAIL("[JsonReader testPass case28]");
          return 0;
        }
        ...
        if(!value8_21->isNull()) {
          TEST_FAIL("[JsonReader testPass case29]");
          return 0;
        }
        ...
        if(value8_22->size() != 0) {
          TEST_FAIL("[JsonReader testPass case30]");
          return 0;
        }
        ...
        if(!value8_23->isNull()) {
          TEST_FAIL("[JsonReader testPass case31]");
          return 0;
        }
        ...
        if(value8_28->size() != 7) {
          TEST_FAIL("[JsonReader testPass case36]");
          return 0;
        }
        ...
        for(int i = 0;i<7;i++) {
          if(value8_28->getIntegerAt(i)->toValue() != (i+1)) {
            ...
            TEST_FAIL("[JsonReader testPass case37]");
            return 0;
          }
        }
        ...
        if(value8_29->size() != 7) {
          TEST_FAIL("[JsonReader testPass case38]");
          return 0;
        }

        for(int i = 0;i<7;i++) {
          if(value8_29->getIntegerAt(i)->toValue() != (i+1)) {
            TEST_FAIL("[JsonReader testPass case39]");
            return 0;
          }
        }
        ...
        if(value8_30 == nullptr) {
          TEST_FAIL("[JsonReader testPass case40]");
          return 0;
        }
            //"{\"object with 1 member\":[\"array with 1 element\"]}",
    ...
    if(value16->toValue() != 1e00) {
      TEST_FAIL("[JsonReader testPass case51]");
      return 0;
    }
    ...
    if(value17->toValue() != 2e+00) {
      TEST_FAIL("[JsonReader testPass case52]");
      return 0;
    }
    ...
    if(value18->toValue() != 2e-00) {
      TEST_FAIL("[JsonReader testPass case53]");
      return 0;
    }
