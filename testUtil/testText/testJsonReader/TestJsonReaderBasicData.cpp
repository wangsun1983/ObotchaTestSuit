...
int basicDataTest() {
    ...
    while(1) {
      JsonReader reader = JsonReader::New()->loadFile(File::New("./test/data/test_basic_01.json"));
    ...
    while(1) {
      JsonReader reader = JsonReader::New()->loadFile(File::New("./test/data/test_basic_02.json"));
      JsonValue value = reader->get();
      Integer v = value->getInteger();
      if(v == nullptr || v->toValue() != -123456789) {
    ...
    while(1) {
      JsonReader reader = JsonReader::New()->loadFile(File::New("./test/data/test_basic_03.json"));
      JsonValue value = reader->get();
    ...
    while(1) {
      JsonReader reader = JsonReader::New()->loadFile(File::New("./test/data/test_basic_04.json"));
      JsonValue value = reader->get();
    ...
    while(1) {
      JsonReader reader = JsonReader::New()->loadFile(File::New("./test/data/test_basic_05.json"));
      JsonValue value = reader->get();
      if(value != nullptr) {
    ...
    while(1) {
      JsonReader reader = JsonReader::New()->loadFile(File::New("./test/data/test_basic_06.json"));
      JsonValue value = reader->get();
      if(value == nullptr) {
    ...
    while(1) {
      JsonReader reader = JsonReader::New()->loadFile(File::New("./test/data/test_basic_07.json"));
      JsonValue value = reader->get();
      if(value == nullptr) {
    ...
    while(1) {
      JsonReader reader = JsonReader::New()->loadFile(File::New("./test/data/test_basic_08.json"));
      JsonValue value = reader->get();
      if(value != nullptr) {
    ...
    while(1) {
      JsonReader reader = JsonReader::New()->loadFile(File::New("./test/data/test_basic_09.json"));
      JsonValue value = reader->get();
      if(value != nullptr) {
