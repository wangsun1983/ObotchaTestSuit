...
void testReflectToSimpleArrayXml() {
  ...
  while(1) {
    ...
    XmlReader reader = createXmlReader()->loadFile(createFile("output3.xml"));
    ...
    if(v0 == nullptr || v0->toValue() != 1) {
      TEST_FAIL("XmlReflect ArrayList To File test2");
      break;
    }
    ...
    if(doubleValue == nullptr || doubleValue->toValue() != 1.1) {
      TEST_FAIL("XmlReflect ArrayList To File test7_1");
      break;
    }

    Double doubleValue2 = rdata3->doublelists->get(1);
    if(doubleValue2 == nullptr || doubleValue2->toValue() != 2.2) {
      TEST_FAIL("XmlReflect ArrayList To File test7_2");
      break;
    }
    ...
    if(v4 == nullptr || v4->toValue() != 1) {
      TEST_FAIL("XmlReflect ArrayList To File test12");
      break;
    }

    Uint32 v5 = rdata3->uint32lists->get(1);
    if(v5 == nullptr || v5->toValue() != 2) {
      TEST_FAIL("XmlReflect ArrayList To File test13");
      break;
    }
    ...
    if(v6 == nullptr || v6->toValue() != 1) {
      TEST_FAIL("XmlReflect ArrayList To File test14");
      break;
    }

    Uint64 v7 = rdata3->uint64lists->get(1);
    if(v7 == nullptr || v7->toValue() != 2) {
      TEST_FAIL("XmlReflect ArrayList To File test15");
      break;
    }
    ...
    if(v8 == nullptr || !v8->sameAs("a")) {
      TEST_FAIL("XmlReflect ArrayList To File test16");
      break;
    }

    String v9 = rdata3->stringlists->get(1);
    if(v9 == nullptr || !v9->sameAs("b")) {
      TEST_FAIL("XmlReflect ArrayList To File test17");
      break;
    }

    TEST_OK("XmlReflect ArrayList To File test18");
    break;
  }
}
