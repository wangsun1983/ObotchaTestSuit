...
void testHashMapUint8Uint8() {
    while(1) {
      ...
      XmlReader reader = XmlReader::New()->loadFile(File::New("./tmp/hashmap_Uint8_Uint8_test1.xml"));
    ...
    while(1) {
      ...
      XmlReader reader = XmlReader::New()->loadFile("./tmp/hashmap_Uint8_Uint8_test2.xml");
      XmlDocument doc2 = reader->get();
