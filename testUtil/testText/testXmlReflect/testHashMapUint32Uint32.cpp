...
void testHashMapUint32Uint32() {
    while(1) {
      ...
      XmlReader reader = XmlReader::New()->loadFile(File::New("./tmp/hashmap_Uint32_Uint32_test1.xml"));
    ...
    while(1) {
      ...
      XmlReader reader = XmlReader::New()->loadFile(File::New("./tmp/hashmap_Uint32_Uint32_test2.xml"));
      XmlDocument doc2 = reader->get();
