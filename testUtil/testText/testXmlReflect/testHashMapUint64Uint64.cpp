...
void testHashMapUint64Uint64() {
    while(1) {
      ...
      XmlReader reader = XmlReader::New()->loadFile(File::New("./tmp/hashmap_Uint64_Uint64_test1.xml"));
    ...
    while(1) {
      ...
      XmlReader reader = XmlReader::New()->loadFile(File::New("./tmp/hashmap_Uint64_Uint64_test2.xml"));
      XmlDocument doc2 = reader->get();
