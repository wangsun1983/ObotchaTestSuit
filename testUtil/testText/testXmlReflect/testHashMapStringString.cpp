...
void testHashMapStringString() {
    while(1) {
      ...
      XmlReader reader = XmlReader::New()->loadFile(File::New("./tmp/map_string_string_test1.xml"));
    ...
    while(1) {
      ...
      XmlReader reader = XmlReader::New()->loadFile(File::New("./tmp/map_string_string_test2.xml"));
      XmlDocument doc2 = reader->get();
    ...
    while(1) {
      ...
      XmlReader reader = XmlReader::New()->loadFile(File::New("./tmp/map_string_string_test4.xml"));
      XmlDocument doc2 = reader->get();
