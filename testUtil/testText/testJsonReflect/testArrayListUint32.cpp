...
void testArrayListUint32() {
    while(1) {
      ...
      if(list2->size() != 5) {
        TEST_FAIL("[JsonReflect ArrayList Uint32 Test case1]");
        break;
      }
      ...
      if(list2->get(0)->toValue() != 1
        ...
        ||list2->get(4)->toValue() != 5) {
          TEST_FAIL("[JsonReflect ArrayList Uint32 Test case2]");
          break;
      }
      break;
    }
    ...
    while(1) {
      ...
      if(list2->list1->get(0)->toValue() != 1
        ...
        ||list2->list1->get(4)->toValue() != 5) {
          TEST_FAIL("[JsonReflect ArrayList Uint32 Test case3]");
          break;
      }
      ...
      if(list2->list2->get(0)->toValue() != 6
        ...
        ||list2->list2->get(4)->toValue() != 10) {
          TEST_FAIL("[JsonReflect ArrayList Uint32 Test case4]");
          break;
      }
      break;
    }

    TEST_OK("[JsonReflect ArrayList Uint32 Test case100]");
}
