...
void testHashMapUint64Uint64() {
    while(1) {
      ...
      JsonReader reader = createJsonReader()->loadFile(createFile("./tmp/hashmap_Uint64_Uint64_test1.json"));
    ...
    while(1) {
      ...
      JsonReader reader = createJsonReader()->loadFile(createFile("./tmp/hashmap_Uint64_Uint64_test2.json"));
      JsonValue value2 = reader->get();
