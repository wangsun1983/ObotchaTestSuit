...
void testFutureInterrupt() {
    while(1) {
        ...
        Thread t1 = createThread([&] {
            ...
            auto r = w->stop();
            if(r < 190 || r > 220) {
                TEST_OK("Filament Future Interrupt case1,r is %d",r);
            }
        });
        t1->start();
        ...
        Thread t2 = createThread([&] {
            ...
            auto r = w->stop();
            if(r < 190 || r > 220) {
                TEST_OK("Filament Future Interrupt case2,r is %d",r);
            }
        });
        t2->start();
        ...
        Thread t3 = createThread([&] {
            ...
            auto r = w->stop();
            if(r < 190 || r > 220) {
                TEST_OK("Filament Future Interrupt case3,r is %d",r);
            }
        });
        t3->start();
        ...
        Thread t4 = createThread([&] {
            ...
            auto r = w->stop();
            if(r < 190 || r > 220) {
                TEST_OK("Filament Future Interrupt case4,r is %d",r);
            }
        });
        t4->start();
        ...
        Thread t5 = createThread([&] {
            ...
            auto r = w->stop();
            if(r < 190 || r > 220) {
                TEST_OK("Filament Future Interrupt case5,r is %d",r);
            }
        });
        t5->start();
        usleep(1000*200);
