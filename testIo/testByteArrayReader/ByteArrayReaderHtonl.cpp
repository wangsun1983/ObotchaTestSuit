...
void testByteArrayReaderHtonl() {
    while(1) {
        ...
        ByteArray array1 = createByteArray(data1,sizeof(uint32_t));
        ByteArrayReader littleReader1 = createByteArrayReader(array1);
        ...
        ByteArrayReader bigReader2 = createByteArrayReader(array1,st(IO)::Endianness::Big);
    ...
    while(1) {
        ...
        ByteArray array1 = createByteArray(data1,sizeof(uint16_t));
        ByteArrayReader littleReader1 = createByteArrayReader(array1);
