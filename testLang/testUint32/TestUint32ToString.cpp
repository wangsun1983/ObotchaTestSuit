...
void testtostring() {
   ...
   while(1) {
     for(int i = 0;i < 100;i++) {
       Uint32 t1 = Uint32::New(i);
       Uint32 t2 = st(Uint32)::ParseHexString(String::New(HexTable[i]));
       Uint32 t3 = Uint32::New(t2);
       if(t1 != t3) {
     ...
     for(int i = 0;i < 100;i++) {
       Uint32 t1 = Uint32::New(i);
       Uint32 t2 = st(Uint32)::ParseOctString(String::New(OctTable[i]));
       Uint32 t3 = Uint32::New(t2);
