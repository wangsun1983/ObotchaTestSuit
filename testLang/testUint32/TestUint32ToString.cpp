...
void testtostring() {
   ...
   while(1) {
     for(int i = 0;i < 100;i++) {
       ...
       if(v1 != v2) {
         TEST_FAIL("Uint32 toString test1");
         break;
       }
     }
     ...
     for(int i = 0;i < 100;i++) {
       ...
       if(v1 != v2) {
         TEST_FAIL("Uint32 toString test2");
         break;
       }
     }
     ...
     for(int i = 0;i < 100;i++) {
       ...
       if(v1 != v2) {
         TEST_FAIL("Uint32 toString test3");
         break;
       }
     }

     TEST_OK("Uint32 toString test4");
     break;
   }
   ...
   while(1) {
     for(int i = 0;i < 100;i++) {
       Uint32 t1 = createUint32(i);
       Uint32 t2 = st(Uint32)::ParseHexString(createString(HexTable[i]));
       Uint32 t3 = createUint32(t2);
       if(t1 != t3) {
         TEST_FAIL("Uint32 toInt test1");
         break;
       }
     }
     ...
     for(int i = 0;i < 100;i++) {
       Uint32 t1 = createUint32(i);
       Uint32 t2 = st(Uint32)::ParseOctString(createString(OctTable[i]));
       Uint32 t3 = createUint32(t2);

       if(t1 != t3) {
         TEST_FAIL("Uint32 toInt test2");
         break;
       }
     }
     ...
     for(int i = 0;i < 100;i++) {
       ...
       Uint32 t2 = st(Uint32)::ParseBinaryString(str);
       Uint32 t3 = createUint32(t2);
        if(t1 != t3) {
         TEST_FAIL("Uint32 toInt test3");
         break;
       }
     }

     TEST_OK("Uint32 toInt test10");
     break;
   }
}
